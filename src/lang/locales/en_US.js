...
export default {
  ...
  'user.login-wallet': 'AuctionX Super Admin',
  ...
  'menu.system-memory': 'System Analytics',
  'menu.notebook': 'Notebook',
  'menu.delivery_conflicts': 'Delivery Conflicts',
  'menu.auctions': 'Auctions',
  'menu.logs': 'Server Logs',
  'menu.user': 'User',
  'menu.add': 'Add',
  'menu.list': 'List',
  ...
  'menu.vendor': 'Vendor',
  'menu.auction.config': 'Auction configuration',
  'menu.profile-page': 'Profile Page',
  'menu.player': 'Players',
  'menu.t-and-c': 'Terms & Conditions',
  'menu.bids-log': 'Bid Logs ',
  'menu.play-account': 'Play Accounts',
  'menu.referral-code': 'Referral Config',
  'menu.winner-log': 'Winner Logs',
  'menu.prize-distribution': 'Prize Distribution',
  'menu.auction-house': 'CLAN',
  'menu.playsAuction': 'XPs/Auctions',
  'menu.followUser': 'Verify Followed User',
  'menu.payment-gateway': 'Payment Gateway',
  'menu.revenue': 'Revenue',
  'menu.plans': 'Plans',
  'menu.supported-chain': 'Supported Chain',
  'menu.request-received': 'Request Received',
  ...
  'dashboards.auction-house': 'CLANs',
  'dashboards.completed-orders': 'Completed Orders',
  'dashboards.total-bidders': 'Total Bidders',
  'dashboards.refund-requests': 'Refund Requests',
  'dashboards.total-bids': 'Total Bids',
  'dashboards.new-comments': 'New Comments',
  'dashboards.embedded-auctions': 'Embedded Auctions',
  'dashboards.sales': 'Sales',
  'dashboards.bid-placed': 'Bid Placed',
  'dashboards.xp-bought': 'XPs Bought',
  'dashboards.xp-spent': 'XPs Spent',
  'dashboards.xp-remaining': 'XPs Remaining',
  'dashboards.xp-utilization': 'XPs Utilization',
  'dashboards.free-xp': 'Free XPs Given',
  ...
  'dashboards.auction-asset-categories': 'Auction Asset Categories',
  'dashboards.cakes': 'Cakes',
  'dashboards.tickets': 'Tickets',
  'dashboards.governance-proposals': 'Governance Proposals',
  'dashboards.calendar': 'Calendar',
  'dashboards.upcoming-auctions-calendar': 'Upcoming Auction Calendar ',
  'dashboards.best-sellers': 'Best Sellers',
  'dashboards.popular-auction-assets': 'Popular Auction Assets',
  'dashboards.website-visits': 'Website Visits',
  'dashboards.aux-sales': '$AuX Sale',
  ...
  'pages.onboard-players': 'ONBOARD PLAYERS',
  'pages.supported-chain': 'Supported Chain',
  ...
  'pages.filtervalue': 'Filter value : ',
  ...
  'product.overheadcost': 'Overhead cost',
  'action.edit': 'Edit',
  ...
  'deletemodal.body': 'Do you really want to delete ',
  'deletemodal.delete': 'Delete',
  'editmodal.edit': 'Edit',
  'deletemodal.cancel': 'Cancel',
  'deletemodal.body-cancel': 'Do you really want to cancel ',
  'deletemodal.body-delete': 'Do you really want to delete ',
  'editmodal.body-resolved': 'Do you really want to set conflict as resolved',
  'editmodal.body-pending': 'Do you really want to set conflict as pending',
  'deletemodal.yes': 'Yes',
  'deletemodal.no': 'No',
  'editmodal.yes': 'Yes',
  'editmodal.no': 'No',
  ...
  'modal.expire': 'Expire',
  'auction.stop': 'Stop',
  'onboard-modal.title': 'Onboard Players',
  'modal.plays-expiration-confirmation': 'PLAYs Expire Confirmation',
};
