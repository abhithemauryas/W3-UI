      ...
      <Colxx xxs="12">
        ...
        <Row>
              ...
              <CardBody>
                <div className="text-center">
                  ...
                  <NavLink to={`${adminRoot}/cards`}>
                    <CardSubtitle className="mb-1">Admin</CardSubtitle>
                  </NavLink>
          ...
          <Colxx md="6" sm="6" lg="4" xxs="12">
            ...
            <Card className="d-flex flex-row mb-4">
              <NavLink to={`${adminRoot}/cards`} className="d-flex">
                <ThumbnailLetters rounded text="Admin" className="m-4" />
              </NavLink>
              <div className=" d-flex flex-grow-1 min-width-zero">
                <CardBody className=" pl-0 align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero">
                  <div className="min-width-zero">
          ...
          <Colxx md="6" sm="6" lg="4" xxs="12">
            ...
            <Card className="d-flex flex-row mb-4">
              <NavLink to={`${adminRoot}/cards`} className="d-flex">
                <ThumbnailLetters rounded small text="Admin" className="m-4" />
              </NavLink>
              <div className=" d-flex flex-grow-1 min-width-zero">
                <CardBody className=" pl-0 align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero">
                  <div className="min-width-zero">
