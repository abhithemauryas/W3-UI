...
class Sidebar extends Component {
  ...
  getMenuClassesForResize = (classes) => {
    ...
    // Below line of code is for sidemenu to hide menu when selected.
  ...
  filteredList = (menuItems) => {
    ...
    if (currentUser) {
      return menuItems.filter(
        (x) =>
          (x.roles && x.roles.includes(currentUser.userInfo.Role.name)) ||
          !x.roles
      );
    }
    return menuItems;
  ...
  menuButtonClick = (e, _clickCount, _conClassnames) => {
    e.preventDefault();
    const { selectedMenuHasSubItems } = this.props;
    setTimeout(() => {
  ...
  render() {
    const { menuClickCount, containerClassnames } = this.props;
    const openMenu = containerClassnames.includes('main-hidden sub-hidden');
      ...
      <div className="sidebar">
        <div className="main-menu">
          <div className="scroll">
            ...
            >
              <i
                className={`simple-icon-arrow-left arrow-icon ${
                  // eslint-disable-next-line react/destructuring-assignment
                  this.props.menuClickCount !== 0 ? 'arrow-icon-rotate' : ''
                } `}
              />
            </NavLink>
            <PerfectScrollbar
            ...
            >
                      ...
                      >
                        {item.newWindow ? (
                          ...
                          >
                            ...
                            {!openMenu && <IntlMessages id={item.label} />}
                          </NavLink>
                        )}
                      </NavItem>
                    );
              ...
              >
                <i
                  className={`simple-icon-arrow-left arrow-icon ${
                    // eslint-disable-next-line react/destructuring-assignment
                    this.props.containerClassnames.includes(
                      'main-show-temporary'
                    )
                      ? 'arrow-icon-rotate'
                      : ''
