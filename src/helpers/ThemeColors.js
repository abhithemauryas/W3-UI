...
export const ThemeColors = () => {
  ...
  return {
    ...
    greenColor: rootStyle.getPropertyValue('--green-color').trim(),
    redColor: rootStyle.getPropertyValue('--red-color').trim(),
    greenColorLight: rootStyle.getPropertyValue('--green-color-light').trim(),
    redColorLight: rootStyle.getPropertyValue('--red-color-light').trim(),
    greenForestLight: rootStyle.getPropertyValue('--green-forest-light').trim(),
    greenForest: rootStyle.getPropertyValue('--green-forest').trim(),
  };
};
